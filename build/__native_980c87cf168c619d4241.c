...
PyObject *CPyDef_http___construct_user_agent(PyObject *cpy_r_module, PyObject *cpy_r_class_name) {
    ...
    PyObject *cpy_r_r12;
    PyObject *cpy_r_r13;
    cpy_r_r0 = CPyStatics[34]; /* ('__version__',) */
    cpy_r_r1 = CPyStatics[35]; /* ('web3_version',) */
...
double CPyDef_math___percentile(PyObject *cpy_r_values, double cpy_r_percentile) {
    ...
    cpy_r_r3 = CPyStatics[13]; /* '' */
    cpy_r_r4 = CPyStatics[14]; /* 'Expected a sequence of at least 1 integers, got ' */
    cpy_r_r5 = CPyStatics[15]; /* '{!r:{}}' */
    cpy_r_r6 = CPyStatics[13]; /* '' */
    cpy_r_r7 = CPyStatics[16]; /* 'format' */
    ...
    *(PyObject * *)cpy_r_r15 = cpy_r_r11;
    ...
    cpy_r_r18 = CPyStatics[17]; /* 'InsufficientData' */
...
CPyL12: ;
    cpy_r_r25 = CPyStatics[18]; /* 'percentile must be in the range [0, 100]' */
    cpy_r_r26 = CPyStatic_math___globals;
    cpy_r_r27 = CPyStatics[19]; /* 'Web3ValueError' */
...
char CPyDef_math_____top_level__(void) {
    ...
    CPy_DECREF(cpy_r_r4);
CPyL3: ;
    cpy_r_r5 = CPyStatics[37]; /* ('Sequence',) */
    cpy_r_r6 = CPyStatics[11]; /* 'typing' */
    ...
    CPy_INCREF(CPyModule_typing);
    CPy_DECREF(cpy_r_r8);
    cpy_r_r9 = CPyStatics[38]; /* ('InsufficientData', 'Web3ValueError') */
    cpy_r_r10 = CPyStatics[21]; /* 'faster_web3.exceptions' */
...
CPyL16: ;
    ...
    cpy_r_r30 = (PyObject **)&cpy_r_r29;
    cpy_r_r31 = CPyStatics[39]; /* ('hexstr',) */
...
CPyL19: ;
    ...
    cpy_r_r36 = CPyStatics[25]; /* 'bytearray' */
...
CPyL30: ;
    ...
    cpy_r_r53 = CPyStatics[39]; /* ('hexstr',) */
...
char CPyDef_type_conversion_____top_level__(void) {
    ...
    CPy_DECREF(cpy_r_r4);
CPyL3: ;
    cpy_r_r5 = CPyStatics[40]; /* ('Final', 'Union') */
    cpy_r_r6 = CPyStatics[11]; /* 'typing' */
    ...
    cpy_r_r14 = CPyStatics[42]; /* (('eth_utils', 'eth_utils', 'eth_utils'),) */
    cpy_r_r15 = CPyStatic_type_conversion___globals;
    cpy_r_r16 = CPyStatics[28]; /* 'faster_web3/_utils/type_conversion.py' */
    cpy_r_r17 = CPyStatics[29]; /* '<module>' */
    cpy_r_r18 = CPyImport_ImportMany(cpy_r_r14, cpy_r_r11, cpy_r_r15, cpy_r_r16, cpy_r_r17, cpy_r_r13);
    if (!cpy_r_r18) goto CPyL14;
    cpy_r_r19 = CPyStatics[43]; /* ('HexStr',) */
    cpy_r_r20 = CPyStatics[31]; /* 'eth_typing' */
    ...
    CPy_DECREF(cpy_r_r22);
    cpy_r_r23 = CPyStatics[44]; /* ('Web3ValueError',) */
    cpy_r_r24 = CPyStatics[21]; /* 'faster_web3.exceptions' */
    ...
    cpy_r_r28 = CPyStatics[27]; /* 'eth_utils' */
    ...
    cpy_r_r30 = CPyStatics[32]; /* 'to_bytes' */
    ...
    cpy_r_r33 = CPyStatics[32]; /* 'to_bytes' */
    ...
    cpy_r_r37 = CPyStatics[27]; /* 'eth_utils' */
    ...
    cpy_r_r39 = CPyStatics[33]; /* 'to_hex' */
    ...
    cpy_r_r42 = CPyStatics[33]; /* 'to_hex' */
...
const char * const CPyLit_Str[] = {
    ...
    "\004\016Web3ValueError\bSequence\026faster_web3.exceptions\0020x",
    "\005\034Expected a hex string. Got: \006hexstr\tbytearray\005Union\teth_utils",
    "\004%faster_web3/_utils/type_conversion.py\b<module>\006HexStr\neth_typing",
    "\002\bto_bytes\006to_hex",
    "",
};
...
const int CPyLit_Tuple[] = {
    11, 1, 3, 1, 4, 1, 10, 1, 20, 2, 17, 19, 1, 24, 2, 10, 26, 3, 27,
    27, 27, 1, 41, 1, 30, 1, 19
};
