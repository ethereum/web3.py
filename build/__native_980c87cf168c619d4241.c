...
CPyL31: ;
    ...
    cpy_r_r54 = CPyStatics[39]; /* ('hexstr',) */
...
CPyL3: ;
    ...
    cpy_r_r14 = CPyStatics[42]; /* (('faster_eth_utils', 'faster_eth_utils',
                                    'faster_eth_utils'),) */
    ...
    cpy_r_r28 = CPyStatics[32]; /* 'to_bytes' */
    ...
    cpy_r_r31 = CPyStatics[32]; /* 'to_bytes' */
    ...
    cpy_r_r35 = CPyStatics[33]; /* 'to_hex' */
    ...
    cpy_r_r38 = CPyStatics[33]; /* 'to_hex' */
...
const char * const CPyLit_Str[] = {
    ...
    "\005\034Expected a hex string. Got: \006hexstr\tbytearray\005Union\020faster_eth_utils",
