...
- Revert pin of `eth-typing` to utilize `EthPM` types. (`#3349 <https://github.com/ethereum/web3.py/issues/3349>`__)
...
- `#3339 <https://github.com/ethereum/web3.py/issues/3339>`__
