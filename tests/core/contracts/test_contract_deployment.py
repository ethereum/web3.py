...
def test_contract_deployment_with_constructor_with_arguments_strict(web3_strict_types,
        ...
        blockchain_code = web3_strict_types.eth.getCode(contract_address)
        assert blockchain_code == decode_hex(WITH_CONSTRUCTOR_ARGUMENTS_RUNTIME)


def test_contract_deployment_with_constructor_with_arguments_strict_error(web3_strict_types,
                                                                          WithConstructorArgumentsContractStrict,  # noqa: E501
                                                                          WITH_CONSTRUCTOR_ARGUMENTS_RUNTIME):  # noqa: E501
    with pytest.raises(
        TypeError,
