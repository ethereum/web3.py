...
def test_checker_simple():
    ...
    assert warnings == {
        ...
        "sources": """Manifest is missing a sources field, which defines a source """
        """tree that should comprise the full source tree necessary to recompile the """
        """contracts contained in this release.""",
        "contractTypes": """Manifest does not contain any 'contractTypes'. """
