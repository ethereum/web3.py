...
class PersistentWebSocket(object, metaclass=DeprecationMetaClass):
    def __init__(
        self,
        endpoint_uri: URI,
...
class WebsocketProvider(JSONBaseProvider, metaclass=DeprecationMetaClass):
